            ...
            <div className="max-w-6xl mx-auto px-6 py-4">
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <a href="#expertise" className="hover:text-amber-600 dark:hover:text-amber-400 transition-colors">Expertise</a>
                        <a href="#writing" className="hover:text-amber-600 dark:hover:text-amber-400 transition-colors">Writing</a>
                        <a href="#resume" className="hover:text-amber-600 dark:hover:text-amber-400 transition-colors">Resume</a>
                        <a href="#contact" className="hover:text-amber-600 dark:hover:text-amber-400 transition-colors">Contact</a>
